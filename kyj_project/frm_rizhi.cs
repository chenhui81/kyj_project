...
{
    public partial class frm_rizhi : Form
    {
        string id_sel = "";//选中的ID
        ...
        public void Load_data()
        {
            try
            {
                ...
                string sqlstr = "select * from log_data where 1=1 ";
                string sqlstr1 = "select count(*) from log_data where 1=1 ";

                string str_where = "";

                if (this.comb_leixing.Text != "")
                {
                    str_where += " and leibie='" + this.comb_leixing.Text + "'";
                }

                if (this.comb_xitong.Text != "")
                {
                    str_where += " and leibie_sys='" + this.comb_xitong.Text + "'";
                }
        ...
        private void frm_rizhi_Load(object sender, EventArgs e)
        {
            this.Format_grid();
